...
const DEFAULT_SHORTCUTS = {
  ...
  async function initializeShortcuts() {
    ...
    keydownListener = (e) => {
      ...
      // This part is correct and should remain. It works because it runs *before* the generic handler.
      ...
      if (selector) {
        // THE PROBLEMATIC CHECK HAS BEEN REMOVED FROM HERE.
        // The listener will now proceed even if focus is in an input field.
